...
<head>
  ...
  <link rel="stylesheet"
        ...
        <link id="browser_favicon" rel="shortcut icon" href="<?php echo PREPEND_PATH; ?>resources/images/appgini-icon.jpg">
...
<div class="container">
					<center>
					<h1>Welcome to the Most Innovative Student Management System</h1>
					<p> The Management of Students is our concern </p>
        <!-- ./col -->
				<img class="circle" src="images/xx.png" style="width: 400px"></img>
			</center><br>
      </div>
